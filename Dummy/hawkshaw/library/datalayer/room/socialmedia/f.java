...
public final class f implements Callable {
    ...
    public final /* synthetic */ UnprocessedSocialMediaDao_Impl f4954b;

    public f(UnprocessedSocialMediaDao_Impl unprocessedSocialMediaDao_Impl, D d5) {
        this.f4954b = unprocessedSocialMediaDao_Impl;
        this.f4953a = d5;
    }

    public final Object call() {
        UnprocessedSocialMediaDao_Impl unprocessedSocialMediaDao_Impl = this.f4954b;
